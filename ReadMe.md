...
~~![GitLab Build Status](https://gitlab.com/KOLANICH-libs/Bin2Text.py/badges/master/pipeline.svg)~~
~~![GitLab Coverage](https://gitlab.com/KOLANICH-libs/Bin2Text.py/badges/master/coverage.svg)~~
